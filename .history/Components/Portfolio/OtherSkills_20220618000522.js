				...
				<div className="flex justify-items-start items-center mx-40 gap-10 mt-20">
					<div className="flex  flex-col justify-center items-center">
						...
						<p className="md:text-base text-gray-700 md:text-center sm:text-left sm:text-sm">
							Have been working as a nurse for many years. No matter what emergency or critical situations that we have encounter, I am able to communicate and cooperate with my 
						</p>
					</div>
