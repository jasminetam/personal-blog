	...
	return (
		<Element id="services" name="services">
			<div className="w-full h-full flex flex-col justify-center items-center pb-80">
              ...
              Have been working as a nurse for many years. No matter what emergency or critical situations that we have encounter,
              the communication and cooperation with colleagues are extremely important. These experience ca
						</p>
					</div>
