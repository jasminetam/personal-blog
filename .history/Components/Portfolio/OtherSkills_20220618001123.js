	...
	return (
		<Element id="services" name="services">
			<div className="w-full h-full flex flex-col justify-center items-center pb-80">
              ...
              Have been working as a nurse for many years. I have learnt that communication and cooperation with colleagues are extremely important,
              no matter working in the medical or the technology sector.
						</p>
					</div>
