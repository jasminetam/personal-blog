	...
	return (
		<Element id="services" name="services">
			<div className="w-full h-full flex flex-col justify-center items-center pb-80">
              ...
              By better organization of work, tasks can be done on time according to the importance and urgency. More time can be arranged to deal with sudden changes
						</p>
					</div>
				</div>
			</div>
