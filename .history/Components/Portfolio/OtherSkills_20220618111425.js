	...
	return (
		<Element id="otherskills" name="otherskills">
			...
			<div className="w-full h-full justify-center items-center pb-40">
              ...
              By doing this, we can ensure the <span class="highlight-container"><span class="highlight">quality</span></span> of our work but as well as to improve our performance.
