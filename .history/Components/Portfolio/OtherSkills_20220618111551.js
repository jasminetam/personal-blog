	...
	return (
		<Element id="otherskills" name="otherskills">
			...
			<div className="w-full h-full justify-center items-center pb-40">
              ...
              To make sure our job can be done properly and smoothly <span class="highlight-container"><span class="highlight"></span>towards the same goal, we cannot work alone. We have to keep track on other&apos;s progress and provide feedback if necessary.
