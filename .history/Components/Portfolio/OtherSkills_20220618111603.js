	...
	return (
		<Element id="otherskills" name="otherskills">
			...
			<div className="w-full h-full justify-center items-center pb-40">
              ...
              To make sure our job can be done properly and smoothly <span class="highlight-container"><span class="highlight">towards the same goal</span></span>, we cannot work alone. We have to keep track on other&apos;s progress and provide feedback if necessary.
							By doing this, we can ensure the <span class="highlight-container"><span class="highlight">quality and efficiency</span></span> of our work
							but as well as to <span class="highlight-container"><span class="highlight">improve our performance</span></span>.
