		...
		<Element id="otherskills" name="otherskills">
			...
			<div className="w-full h-full justify-center items-center pb-40">
              ...
              Since I was working as a nurse, I have learnt that communication and cooperation with colleagues are extremely important.
							To make sure our job can be done properly and smoothly <span class="highlight-container"><span class="highlight">towards the same goal</span></span>, we
							cannot work alone. We have to keep track on other&apos;s progress and provide feedback if necessary.
