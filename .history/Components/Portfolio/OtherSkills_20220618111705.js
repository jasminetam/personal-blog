        ...
        <div className="items-center mx-40 gap-10 mt-20">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-sm sm:text-left">
              ...
              opportunity</span></span> to improve our practice and make it as a <span class="highlight-container"><span class="highlight"></span>great
              experience for future challenges. Life-long learners and people
