  ...
  return (
    <Element id="otherskills" name="otherskills">
      ...
      <div className="w-full h-full justify-center items-center pb-40">
        <div className="items-center mx-40 gap-10 mt-20">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-sm sm:text-left">
              ...
              may never seen before. We have to take challenge as a <span class="highlight-container"><span class="highlight">good
              opportunity</span></span> to improve our practice and make it as a <span class="highlight-container"><span class="highlight">great
              experience</span></span> for future challenges. <span class="highlight-container"><span class="highlight">Life-long learners</span></span> and people
              who love challenges can fit in any of the roles in their career
              and life.
            </p>
          </div>
        </div>
        ...
        {/* second grid */}
        <div className="justify-items-start items-center mx-40 gap-10 mt-20">
          <div className="justify-center items-center m-10">
            {/* first block */}
            <div className="flex justify-center items-center cursor-pointer ">
            ...
            <p className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-left sm:text-sm">
              ...
              multiple factors can be difficult to solve. We should not stop
              thinking because the problem solving skills can be build up if we
              always question and keen on thinking the solutions.
            </p>
          </div>
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-left sm:text-sm">
              As nursing is a busy role which require multi-tasking. We have to
              prioritize our work and make sure we can provide our services
              accordingly. By better organization of work, tasks can be done on
              time according to the importance and urgency. More time can be
              arranged to deal with emergency events.
            </p>
          </div>
        </div>
      </div>
