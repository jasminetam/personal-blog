        ...
        <div className="justify-items-start items-center mx-40 gap-10 mt-20">
          <div className="justify-center items-center m-10">
            ...
            <p className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-left sm:text-sm">
              Sometimes situations related to complicated social background or
						  multiple factors can be <span class="highlight-container"><span class="highlight">difficult to solve</span></span>.
						  We should not stop
              thinking because the problem solving skills can be build up if we
              <span class="highlight-container"><span class="highlight">always question and work on various solutions</span></span>.
            </p>
          </div>
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <p className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-left sm:text-sm">
              ...
              <span class="highlight-container"><span class="highlight">prioritize our work</span></span> and make sure we can provide our services
              accordingly. By better organization of work, tasks can be done on
              time according to the <span class="highlight-container"><span class="highlight">importance and urgency</span></span>. More time can be
