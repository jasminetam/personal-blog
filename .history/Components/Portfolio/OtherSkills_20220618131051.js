    ...
    <Element id="otherskills" name="otherskills">
      ...
      <div className="w-full h-full justify-center items-center pb-40">
          ...
          <div className="justify-center items-center m-10">
            ...
            <h5 className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-left sm:text-sm p-5">
		  ...
		  <div className="pt-8 pb-8">
            ...
            <h5 className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-sm sm:text-left p-5">
            ...
            <h5 className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-left sm:text-sm p-5">
              ...
              can be build up if we <span class="highlight-container">
                <span class="highlight">
                  always question</span></span> and <span class="highlight-container">
                <span class="highlight">work on various solutions
                </span>
              </span>
              .
					  </h5>
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <h5 className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-left sm:text-sm p-5">
              ...
              </span> and make sure we can provide our services accordingly. By better
              organization of work, tasks can be done on time according to the<span class="highlight-container">
