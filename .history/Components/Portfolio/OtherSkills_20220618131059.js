      ...
      <div className="w-full h-full justify-center items-center pb-40">
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <h5 className="md:text-base text-gray-700 lg:text-lg md:text-center sm:text-left sm:text-sm p-5">
                ...
                </span> and make sure we can provide our services accordingly. By betterorganization of work,
                tasks can be done on time according to the <span class="highlight-container">
