  ...
  return (
    <Element id="work" name="work">
      <div className="portfolioProjectsWrapper">
        ...
        <div className="portfolioProjectsFlex"></div>
        <div className="portfolioProjectsFirstDiv">
          <div className="portfolioSingleProjectDiv">
            <h3 className="portfolioSingleProjectTitle">Spotifake - Spotify Clone</h3>
          ...
          <div className="portfolioSingleProjectDiv">
            <h3 className="portfolioSingleProjectTitle">Daily Expenses Web App</h3>
            <div className="portfolioSingleProjectImgDiv">
