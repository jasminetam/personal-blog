        ...
        <div>
          <div className="flex justify-between text-center md:mx-20 md:pt-32 pt-28 ">
            ...
            <div className="flex flex-col md:ml-20 mx-10 mt-10">
              ...
              <p className="text-left font-normal text-xl font-serif mb-5 flex-wrap">
              ...
              <a
                href="#"
                className="font-semibold text-white md:mt-10 mt-5 pt-5 bg-indigo-900 rounded-md w-60 h-16 text-lg hover:bg-black m-3"
              >
                See My Portfolio !
              </a>
            </div>
