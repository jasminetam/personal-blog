...
export default function PortfolioHeader() {
  return (
      ...
      <Element id="home" name="home">
        <div>
          <div className="flex justify-between text-center md:mx-20 md:pt-32 pt-28 m-10">
            ...
            <div className="flex flex-col md:ml-20 mx-10 mt-10">
              ...
              <p className="text-left font-normal text-xl font-serif mb-5 flex-wrap m-10 leading-7">
