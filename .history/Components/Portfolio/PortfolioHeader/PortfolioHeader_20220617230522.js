  ...
  return (
      ...
      <Element id="home" name="home">
        <div className="w-full h-full">
          <div className="flex justify-between text-center md:mx-20 md:pt-32 pt-32 shadow">
            <div className=" w-full h-96 shadow-xl rounded-full relative px-10 hidden md:block m-10">
              <Image
							src={heroImage}
							alt="heroImage"
							layout="fill"
            ...
            <div className="flex flex-col md:ml-20 mx-10 mt-10">
              ...
              <a
                href="#"
                className="font-semibold text-white md:mt-10 mt-5 pt-5 bg-indigo-900 rounded-md w-60 h-16 text-lg hover:bg-black mb-50 "
              >
                Contact Me !
              </a>
