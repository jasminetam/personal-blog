          ...
          <div className="flex justify-between text-center md:mx-20 md:pt-32 pt-28 shadow">
            ...
            <div className="flex flex-col md:ml-20 mx-10 mt-50 mb-80">
              ...
              <p className="text-left font-normal text-2xl font-serif mb-5 flex-wrap m-10">
                A self taught <span className="highLightText">react developer</span> with the background as a nurse for
           ...
           <div  className="font-semibold text-white md:mt-10 mt-5 pt-5 bg-indigo-900 rounded-md w-60 h-16 text-lg hover:bg-black mb-50 "></div>
              <Link
                href="/contact"
