    ...
    <Element id="home" name="home">
      <div className="w-full h-full">
        <div className="flex justify-between text-center md:mx-20 md:pt-32 pt-28 shadow">
          ...
          <div className="flex flex-col md:ml-20 mx-10 mt-50 mb-80 sm:m-0">
            ...
            <div className="font-semibold text-white items-center md:mt-10 mt-5 pt-5 bg-indigo-900 rounded-md w-60 h-16 text-lg hover:bg-black mb-50 ">
