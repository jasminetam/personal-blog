  ...
  return (
    <Element id="home" name="home">
      <div className="w-full h-full">
        <div className="flex justify-between text-center md:mx-20 md:pt-32 pt-28 shadow md:flex-column">
          <div className=" w-full h-96 shadow-xl rounded-full relative px-10 ">
            <Image
              src={heroImage}
              alt="heroImage"
              layout="fill"
              objectFit="cover"
              className=" rounded-full cursor-pointer md:flex"
            />
          </div>
          <div className="flex flex-col md:ml-20 mx-10 mt-50 pb-80 sm:m-0">
