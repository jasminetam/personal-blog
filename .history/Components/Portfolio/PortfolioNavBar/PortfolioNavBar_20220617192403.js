  ...
  return (
    <div className="portfolioNavigation">
      <nav className="topLeft">
        ...
        <Transition show={isOpen} enter="transition ease-out duration-100 transform" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="transition ease-in duration-75 transform"
      </nav>
    </div>
  );
}
