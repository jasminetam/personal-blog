          ...
          {(ref) => (
            <div className="md:hidden" id="mobile-menu">
              <div ref={ref} className="bg-white mx-4 mr-20 pt-4 pb-4 space-y-1">
                ...
                <Link href="/portfoli" activeClass="portfotherskillsolio" to="otherskills" smooth={true} offset={50} duration={500} className="portfolioTopNavListItem">OtherSkills</Link>
