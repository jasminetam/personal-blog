...
function SkillSets() {
	return (
		<Element id="Clients" name="Clients">
			<div>
				<div className="w-full my-20 h-auto flex flex-wrap justify-center items-center">
					...
					<div className="flex justify-center text-center mx-20 my-10 md:gap-10 gap-2">
              ...
              <h3>Tailwind CSS</h3>
						...
						<div className="inline-block justify-center items-center cursor-pointer">
              <SiBootstrap className="md:w-20 md:h-20 w-16 h-16 text-gray-500 md:m-3 p-1 hover:text-black" />
              <h3>Bootstrap</h3>
						</div>
						<div className="inline-block justify-center items-center cursor-pointer">
              <SiNodedotjs className="md:w-20 md:h-20 w-16 h-16 text-gray-500 md:m-3 p-1 hover:text-black" />
              <h3>Node.js</h3>
						</div>
						<div className="inline-block justify-center items-center cursor-pointer">
              <SiHtml5 className="md:w-20 md:h-20 w-16 h-16 text-gray-500 md:m-3 p-1 hover:text-black" />
              <h3>HTML 5</h3>
						</div>
						<div className="inline-block justify-center items-center cursor-pointer">
              <SiCss3 className="md:w-20 md:h-20 w-16 h-16 text-gray-500 md:m-3 p-1 hover:text-black" />
              <h3>CSS 3</h3>
						</div>
						<div className="inline-block justify-center items-center cursor-pointer">
              <SiJavascript className="md:w-20 md:h-20 w-16 h-16 text-gray-500 md:m-3 p-1 hover:text-black" />
              <h3>Javascript</h3>
						</div>
						<div className="inline-block justify-center items-center cursor-pointer">
              <SiAmazonaws className="md:w-20 md:h-20 w-16 h-16 text-gray-500 md:m-3 p-1 hover:text-black" />
              <h3>AWS</h3>
						</div>
					</div>
				</div>
