...
import Two from "../../public/image/spotifake.png";
import Three from "../../public/image/spotifake.png";
import Four from "../../public/image/spotifake.png";
	...
	return (
		<Element id="work" name="work">
			<div className="w-full my-20 h-auto flex flex-col justify-center items-center  ">
				<p className="text-sm uppercase text-gunmetal-400">Portfolio</p>
				<h1 className="text-gunmetal-900 text-6xl font-bold text-center">
					All Creative Works
				</h1>
