		...
		<Element id="work" name="work">
			<div className="w-full my-20 h-auto flex flex-col justify-center items-center  ">
				...
				<div className="md:flex sm:flex-col md:flex-row justify-center items-center gap-10 mt-10">
					<div className="rounded w-90 h-60 shadow-xl relative">
						<Image
							src={One}
							alt="One"
							layout="fill"
				...
				<div className="md:flex sm:flex-col md:flex-row justify-center items-start sm:pb-10 md:gap-10 mt-10">
					<div className="rounded w-100 h-60 shadow-xl relative">
						<Image
							src={Four}
							alt="four"
							layout="fill"
					...
					<div className="rounded w-100 h-100 shadow-xl relative">
						<Image
							src={Five}
							alt="five"
							layout="fill"
