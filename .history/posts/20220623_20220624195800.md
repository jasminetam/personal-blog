...
<p> 
For IT development team to work on a project, we will need to implement a development practices and DevOps called CI/CD (Continue Integration vs Continue Delivery vs Continue Depolyment)
