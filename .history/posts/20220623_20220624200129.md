...
Continuous delivery is an extension of continuous integration, automatically deploys all code changes to a testing and/or production environment after the build stage. 
